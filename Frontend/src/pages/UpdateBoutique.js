...
export default function UpdateBoutique(props){
    ...
    function sendData(e){
     ...
     axios.put(`http://localhost:8070/Boutique/updateBoutique/${sessionStorage.editBoutique_id}`,editBoutique).then(()=>{
     

        let editBoutique_id=sessionStorage.editBoutique_id;
        console.log(editBoutique_id);
...
useEffect(() =>{
    const id = props.id;
    let editBoutique_id=sessionStorage.editBoutique_id;
    axios.get(`http://localhost:8070/Boutique/get/Boutique/${editBoutique_id}`).then((res) => {
        console.log(res);
        let data=res.data.boutiquehotels;
