...
function sendData(e){
  ...
  axios.post('http://localhost:8070/Hotel/add',AddHotel).then(()=>{
...
<div className="form-group">
    ...
    <select id="category" className="form-control"  onChange={(e)=>{
      ...
      <option value="Star Class Hotel">Select Category</option>
...
<div className="form-group">
  ...
  <div className="form-group">
   ...
   <input type="text" className="form-control" id="Contact" pattern="[0-9]{10}" onChange={(e)=>{
