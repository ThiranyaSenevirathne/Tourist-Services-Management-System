...
function ManageFGuide() {
    ...
    function onDelete(_id) {
        console.log(_id);
        axios.delete("http://localhost:8070/femaleGuide/delete/" + _id).then((res) => {
    ...
    function update() {
        ...
        axios.put("http://localhost:8070/femaleGuide/update/" + _id, newData).then(() => {
            setfullName("");
            setlocation("");
            setlanguages("");
            setdescription("");
    ...
    return (
        <div>
            <div style={{ paddingRight: '1px', paddingBottom: '1px', paddingTop: '1px', paddingLeft: '87%' }}>
                ...
                <a href="./CreateFemaleGuide">
                    <Button style={{ backgroundColor: "#5c2903", border: "#1dbf99", opacity: 0.7, color: 'white' }}>
                        Create Guide
                    </Button> </a> {' '}
                <a href="./FReport"><Button style={{ backgroundColor: "#4a2617", border: "#1dbf99", opacity: 0.7, color: 'white' }}>
                    Reports
                </Button></a>
            </div>
            ...
            {femaleGuide.filter(femaleGuide => {
                ...
                map((femaleGuide) => {
console.log("my id : ", femaleGuide._id)
                    return (
                            ...
                            <Card  >
                                ...
                                <Card.Body>
                                    ...
                                    {/* <div style={{ float: 'right', paddingRight: '1vh' }}>
                                        <button type='submit'><a href='/ViewSingleFGuide'> Read More... </a></button>
                                    </div> */}

                                    <div style={{ float: 'right', paddingRight: '1vh' }}>
                                        <Button variant="primary" onClick={() => handleShow(femaleGuide._id, femaleGuide.fullName,
                                            femaleGuide.location,
                                            femaleGuide.languages,
                                            femaleGuide.description, 
                                            femaleGuide.contactNo, femaleGuide.Email )}>Edit</Button>{' '}
                                    ...
                                    <Modal show={show} onHide={handleClose}>
                                                    ...
                                                    <Form >
                                                        ...
                                                        <div >
                                                            ...
                                                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                                                ...
                                                                <Form.Control type="text" style={{ color: 'black' }} value={description}
                                        ...
                                        <Button onClick={() => onDelete(femaleGuide._id)}>Delete</Button> {' '}
