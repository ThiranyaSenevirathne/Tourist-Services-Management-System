...
<table className="table1" class="table table-striped text-dark" >
   ...
   {report.map((guesthouses,key)=>(
        <tr key={key}>
            
         
          
            <td scope="row">&nbsp;&nbsp;{guesthouses.Name}</td>
            <td> {guesthouses.Location}</td>
            <td>  &nbsp;&nbsp; {guesthouses.Contact}</td>
            <td><a href={guesthouses.Booking}>For Bookings</a></td>
